...
class SettingsService:
    ...
    async def _get_default_settings(self) -> AppSettings:
        ...
        ai_settings = AISettings(
            providers=ai_providers, default_provider=AIProvider.OPENAI
        )
        ...
        return AppSettings(
            ai=ai_settings, general=general_settings, upload=upload_settings
        )

    async def update_settings(
        self, update_request: SettingsUpdateRequest
    ) -> AppSettings:
